    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PACK_ID', models.IntegerField(verbose_name='PACK_ID')),
                ('NO_OF_ITEMS', models.IntegerField(verbose_name='NO_OF_ITEMS')),
                ('ARABIC_NAME', models.CharField(max_length=200, verbose_name='ARABIC_NAME')),
                ('UNIT_DESC', models.CharField(max_length=200, verbose_name='UNIT_DESC')),
                ('PURCH_PRICE', models.CharField(max_length=200, verbose_name='PURCH_PRICE')),
                ('SALE_PRICE', models.CharField(max_length=200, verbose_name='SALE_PRICE')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('t_no', models.IntegerField(unique=True, verbose_name='T_No')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(validators=[bayanApp.models.Order_MS_VCHR_XO.validate_nonzero], verbose_name='quantity')),
